...
while True:
    ...
    if event == "-CUSTOM-QUERY-":
        ...
        query = "MATCH (p:Person)-[r:WENT_TO]-(pp:PublicPlace{name:'" + place + "'})" + a1 + a2 + " where r.date_in.year =" \
                ...
                "r.date_in.hour <=" + start_time[0] + " and r.date_out.hour >=" + end_time[0] + "))" + a4 + a3 + " return p.name, p.surname, p.cf "
